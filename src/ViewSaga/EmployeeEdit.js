...
import { UpdateEmployeeRequest } from '../Redux-saga/Action/EmployeeAction';
...
export default function EmployeeAdd(props) {
    ...
    return (
        <div>
            ...
            <div>
                <button type='submit' className="cursor-pointer inline-flex justify-center py-2 px-2 shadow-sm text-sm font-medium rounded-md text-green-500 hover:text-green-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" onClick={formik.handleSubmit}><CheckIcon className='basis-1/4 h-6'/>Simpan </button>
                <button className="cursor-pointer inline-flex justify-center py-2 px-2 shadow-sm text-sm font-medium rounded-md text-red-500 hover:text-red-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" onClick={() => props.setDisplay(false)}><XIcon className='basis-1/4 h-6'/>Cancel </button>
            </div>
        </div>
    )
}